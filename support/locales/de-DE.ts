...
export default {
  ...
  components: {
    ...
    backlinks: {
      title: "Wann haben wir das gemacht?",
      noBacklinksFound: "Noch nicht im Unterricht behandelt.",
    },
    themeToggle: {
    ...
    explorer: {
      title: "Auf dieser Website navigieren",
    },
    footer: {
    ...
    tableOfContents: {
      title: "Navigiere auf dieser Seite",
    },
    contentMeta: {
