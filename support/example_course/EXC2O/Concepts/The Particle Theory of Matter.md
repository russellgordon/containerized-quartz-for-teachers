---
createdSection1: 2026-03-09T08:00:00.000-0500
draftSection1: false
createdSection2: 2026-03-11T08:00:00.000-0500
draftSection2: false
enableToc: true
tags:
  - chemistry
...
```mermaid
graph LR
    S["Solid: fixed positions, vibrating"] -->|"add energy: melting"| L["Liquid: touching, sliding"]
    L -->|"add energy: evaporating"| G["Gas: far apart, fast"]
    G -->|"remove energy: condensing"| L
    L -->|"remove energy: freezing"| S
```
