---
createdSection1: 2026-04-03T08:00:00.000-0500
draftSection1: false
createdSection2: 2026-04-05T08:00:00.000-0500
draftSection2: false
enableToc: true
tags:
  - physics
...
```mermaid
graph LR
    A["Neutral object"] -->|"rub with cloth"| B["Electrons transferred"]
    B --> C["One object negative, the other positive"]
    C -->|"like charges"| D["Repel"]
    C -->|"opposite charges"| E["Attract"]
```
...
> vapour, so charge accumulates instead of draining — hence doorknobs in
> February.
