...
```mermaid
graph LR
    BIO["Biology"] --> ECO["Ecosystems, cycles, climate"]
    CHEM["Chemistry"] --> MAT["Matter, atoms, the periodic table"]
    PHYS["Physics"] --> ELEC["Charge, circuits, energy"]
    SPACE["Earth and Space"] --> SS["The Sun, the solar system, the universe"]
```
