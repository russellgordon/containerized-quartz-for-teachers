---
createdSection1: 2026-03-03T08:00:00.000-0500
draftSection1: false
createdSection2: 2026-03-05T08:00:00.000-0500
draftSection2: false
enableToc: true
tags:
  - biology
...
```mermaid
graph TD
    SUN["Sunlight, mostly visible"] --> SURF["Earth's surface warms"]
    SURF --> IR["Surface radiates infrared"]
    IR --> GHG["Greenhouse gases absorb infrared"]
    GHG -->|"re-radiated in all directions"| SURF
    GHG --> SPACE["Some escapes to space"]
```
