...
> Everything below is a placeholder written for a computer science course. Edit it,
...
1. Read code together: what does this do, and how do you know? — [[Examples/index|Examples]]
2. Try it: change one thing and predict what happens
3. Name the idea — [[Concepts/index|Concepts]]
4. Build: work time on the current project — [[Exercises/index|Exercises]]
5. Share one thing that broke, and what fixed it
