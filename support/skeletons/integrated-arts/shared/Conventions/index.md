...
tags:
  - conventions
---
The shared vocabulary of the form, one page per convention.

A convention is a way of making meaning that everyone in the room agrees on.
Name each one, show it, and link to it from the day it is first used.
