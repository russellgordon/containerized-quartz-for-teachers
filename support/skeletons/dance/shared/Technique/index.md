...
tags:
  - technique
---
How the body does it — one page per technique.

Technique pages age well. Write them once, with what to look for and what
usually goes wrong, and link to them whenever the technique returns.
