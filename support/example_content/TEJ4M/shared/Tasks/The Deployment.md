...
4. **Firmware and system configuration**, per
   [[Firmware and System Optimisation]]: versions recorded, settings
   listed, and a before-and-after measurement for every optimisation
   you claim.
5. **The network**, addressed and documented per
   [[Addressing at Scale]] — what is static, what is reserved, what is
   dynamic, and where the subnet boundaries fall.
...
| --- | --- |
| Knowledge | Components, services, and addressing chosen correctly for the requirements |
| Thinking | Trade-offs identified and decided, not avoided; the purchasing argument holds under questioning |
| Application | It works, it is measured, and the permission matrix behaves as documented |
| Communication | A handover package in the client's language, and a defence that answers the question asked |
