---
title: The Human-Resource Process
draft: false
created: __CREATED__
tags:
  - concepts
...
```mermaid
graph LR
    P["Planning<br/>what will we need?"] --> R["Recruitment<br/>who could do it?"]
    R --> S["Selection<br/>who will?"]
    S --> O["Orientation<br/>a good first month"]
    O --> D["Development<br/>growing the capability"]
```
