...
```mermaid
graph LR
    A["Name the destination"] --> B["Find the official page"]
    B --> C["Copy the requirements, exactly"]
    C --> D["Compare with your courses so far"]
    D --> E["List what is missing, and by when"]
    E --> F["Find one person who took this route"]
```
