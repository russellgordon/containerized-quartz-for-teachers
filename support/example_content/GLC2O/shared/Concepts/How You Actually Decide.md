...
```mermaid
graph TD
    A["Name the decision, in one sentence"] --> B["List what matters to you"]
    B --> C["Gather the options — including ones you dislike"]
    C --> D["Test each option against your criteria"]
    D --> E["Talk it through with someone"]
    E --> F["Decide, and write down why"]
    F --> G["Check later: did it hold?"]
    G -->|No| B
```
