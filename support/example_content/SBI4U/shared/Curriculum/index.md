...
enableToc: true
---
Every expectation the Ministry sets for SBI4U, one page each, so a
...
```mermaid
graph TD
    A["A. Scientific Investigation Skills and Career Exploration"]
    B["B. Biochemistry"]
    C["C. Metabolic Processes"]
    D["D. Molecular Genetics"]
    E["E. Homeostasis"]
    F["F. Population Dynamics"]
    A --> B
    B --> C
    C --> D
    D --> E
