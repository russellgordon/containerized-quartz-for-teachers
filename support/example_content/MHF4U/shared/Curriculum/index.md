...
```mermaid
graph TD
    P["Mathematical Processes"] --> A["A. Exponential and Logarithmic Functions"]
    P["Mathematical Processes"] --> B["B. Trigonometric Functions"]
    P["Mathematical Processes"] --> C["C. Polynomial and Rational Functions"]
    P["Mathematical Processes"] --> D["D. Characteristics of Functions"]
```
