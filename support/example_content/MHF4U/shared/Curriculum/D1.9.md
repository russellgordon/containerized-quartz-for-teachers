...
*Sample problem:* The height, h metres, of a ball above the ground can be modelled by the function h(t) = – 5t² + 20t, where t is the time in seconds. Use average speeds to determine the approximate instantaneous speed at t = 3. ^text
