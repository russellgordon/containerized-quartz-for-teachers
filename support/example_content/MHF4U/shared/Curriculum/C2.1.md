...
*Sample problem:* Investigate, with technology, the key features of the graphs of families of rational functions of the form $f(x) = \frac{1}{x + n}$ and $f(x) = \frac{1}{x^2 + n}$, where $n$ is an integer, and make connections between the equations and key features of the graphs. ^text
