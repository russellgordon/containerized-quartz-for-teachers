...
*Sample problem:* Investigate, using graphing technology, key features of the graphs of the family of rational functions of the form f(x) = 8x/(nx + 1) for n = 1, 2, 4, and 8, and make connections between the equations and the asymptotes. ^text
