...
- [ ] Foggy things are located, not just felt — "I skip the domain
      check on my log-equation candidates", not "logs are confusing"
...
> evidence of growth the day a later entry says "I fed our
> concentration model the hour of data we had held back, and it
> caught the asymptote I had guessed wrong" — a loop from intention
> to attempt to result. That loop is exactly what [[Showing Growth]]
