...
tags:
  ...
  - unit-2
---
Nobody in this trade carries all of it in their head. What working
growers have is a short list of sources they trust and a fast way of
checking a new one. Building that list is worth more than memorizing any
single fact — pest ranges change, regulations change, and the equipment
manual is always for the machine you have never seen before.
...
Municipal foresters and master gardener programs answer local questions
no national source can.
...
> and a post from a company selling the solution are both useful, but
> not in the same way.
> **Where does it apply?** Advice written for a warmer climate can be
> confidently, precisely wrong here.
> **When was it written?** A page with no date cannot be checked.
