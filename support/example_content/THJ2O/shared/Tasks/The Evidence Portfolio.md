...
tags:
  ...
  - unit-4
---
**The final evaluation. Submitted complete, with a practical
demonstration in the examination period.** Individual.

The portfolio is what you would show an employer, a college, or an
apprenticeship sponsor — evidence that you can do this work.
...
## The practical demonstration (examination period)

You are given three short tasks drawn from the year — a propagation
task, a measurement and calculation, and a tool selection with a safety
justification — and you carry them out while I watch. You explain what
you are doing and why as you go.

## The written section

1. **Where this leads**: three careers in the green industries you have
   researched, what each requires, and how someone actually gets in.
2. **How you would get there**: part-time work, co-operative education,
   apprenticeship, college, volunteering, or a program you have found.
   Name at least one group or program that exists to support people
...
> Every year somebody tries to assemble this in the last week and
> discovers the photographs were never taken. Take them in week one —
