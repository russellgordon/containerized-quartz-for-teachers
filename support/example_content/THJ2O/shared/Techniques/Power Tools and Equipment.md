...
tags:
  ...
  - unit-2
---
A powered tool does not care what it is cutting. That is the whole
difference between it and a hand tool: a spade stops when it meets
something hard, and a mower blade does not.
...
Twenty seconds, every time. Cord and plug intact, with no tape over a
repair. All guards present and moving freely. Blade or line correct and
...
- **Let it reach full speed before it meets the material**, and let it
  stop on its own. Never grab a coasting blade.
- **Keep both hands where the design intends.** If the job needs a hand
  where a hand should not be, it needs a clamp or a jig.
...
- **Maintain it on a schedule**, because that is half of why a machine is
  safe — [[Maintaining Your Tools]] and [[The Safety Ticket]].
