...
```mermaid
graph TD
    AA["AA. Social-Emotional Learning Skills"] --> B["B. Number"]
    AA --> C["C. Algebra"]
    AA --> D["D. Data"]
    AA --> E["E. Geometry and Measurement"]
    AA --> F["F. Financial Literacy"]
    A["A. Mathematical Thinking and Making Connections"] --> B
    A --> C
    A --> D
    A --> E
    A --> F
