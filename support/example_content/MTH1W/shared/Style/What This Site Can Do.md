...
The curriculum asks us to model mathematics in code, and pages carry
runnable examples with the spacing and quotation marks preserved:
...
[[Coding/index|the Coding folder]] uses this.
...
- A plain link: [[Slope and Rate of Change]]
- A link with different words: [[Slope and Rate of Change|how fast it climbs]]
- A link to a section: [[Slope and Rate of Change#Reading slope from a graph]]

**How that was made:** double square brackets.

```markdown
[[Slope and Rate of Change]]
[[Slope and Rate of Change|different words for the link]]
[[Slope and Rate of Change#Reading slope from a graph]]
```
...
[[Slope and Rate of Change]] and its backlinks list every exploration and
