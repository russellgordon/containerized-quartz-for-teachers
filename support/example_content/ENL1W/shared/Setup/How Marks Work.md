...
**70%** comes from the work of the course — tasks, discussions,
presentations, and writing done across the term. **30%** is the final
evaluation: [[The Portfolio Conversation]], which happens in the last
week.

Within the 70%, later work counts for more than earlier work. A first
essay written in September and a fourth written in January are not
weighted equally, because the second one is better evidence of what you
can now do.
