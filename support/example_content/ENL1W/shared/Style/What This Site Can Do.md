...
> The narrator is unreliable: he tells us the fight was "nothing", and
> three paragraphs later cannot look at his brother.
...
| --- | --- | --- |
| Simile | Compares using *like* or *as* | "I Lost My Talk" |
| Allusion | Points at another text or event | *The Marrow Thieves* |
| Juxtaposition | Sets two things side by side to make a point | "Borders" |
...
Two lines of Rita Joe's "I Lost My Talk", set as a block quotation
because they are longer than a phrase. Block quotations take no quotation
marks — the indent does that job. The conventions are on
[[Writing About Texts]].
...
timeline
    ...
    1978 : Rita Joe : "I Lost My Talk"
    1993 : Thomas King : "Borders"
    2012 : Richard Wagamese : Indian Horse
...
links here, gathered automatically. Open [[Point of View]] and you can
