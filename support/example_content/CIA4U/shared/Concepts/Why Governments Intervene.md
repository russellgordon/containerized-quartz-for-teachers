...
```mermaid
graph LR
  A["Public good"] --> B["Direct provision"]
  C["Externality"] --> D["Tax, subsidy, or price"]
  E["Market power"] --> F["Competition law"]
  G["Information gap"] --> H["Disclosure rules"]
  I["Distribution"] --> J["Taxes and transfers"]
```
