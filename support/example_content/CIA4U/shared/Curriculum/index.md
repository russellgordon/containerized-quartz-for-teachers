...
```mermaid
graph TD
    A["A. Economic Inquiry and Skill Development"]
    B["B. Fundamentals of Economics"]
    C["C. Firms, Markets, and Economic Stakeholders"]
    D["D. Macroeconomics"]
    E["E. Global Interdependence and Inequalities"]
    A --> B
    A --> C
    A --> D
    A --> E
