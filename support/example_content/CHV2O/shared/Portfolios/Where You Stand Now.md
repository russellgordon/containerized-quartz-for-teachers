...
tags:
  ...
  - unit-3
---
The final portfolio entry, written after [[The Civic Action Project]] is
...
position on it. Not a balanced summary — a position, of the kind
described in [[Values That Pull Against Each Other]].

A position that earns marks has four parts:

1. **The claim**, in one sentence, specific enough to be wrong.
2. **The values underneath it.** Which of democracy, human rights,
   freedom, the rule of law, equality or the common good are you ranking
   above which, and why. This is the part most students omit, and it is
   the part that makes a position yours rather than borrowed.
3. **The evidence**, cited so a reader can check it.
4. **The strongest objection**, stated as its holders would state it, and
   your answer to it.

You are marked on the reasoning and the honesty, never on which position
you take. Nobody in this course has ever lost a mark for a conclusion.
...
> [!tip] "Nothing changed" is allowed, and it has to be earned
> If your view held, say what tested it — which source, which seminar,
> whose argument — and why it survived. A position that has been attacked
> and held is worth more than one that was never examined. A position
