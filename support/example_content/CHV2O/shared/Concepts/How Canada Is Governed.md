...
```mermaid
graph TD
    A["You mark one name<br/>in your riding"] --> B["Most votes in that<br/>riding wins the seat"]
    B --> C["Seats are counted<br/>across the country"]
    C --> D["The party that can hold<br/>the confidence of the House<br/>forms the government"]
    D --> E["Its leader becomes<br/>Prime Minister and<br/>chooses a Cabinet"]
```
