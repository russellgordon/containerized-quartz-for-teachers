...
```mermaid
graph LR
    I["An issue"] --> A["Direct request<br/>to a decision-maker"]
    I --> B["Formal process<br/>consultation, deputation,<br/>petition, submission"]
    I --> C["Organising<br/>numbers and pressure"]
    I --> D["Litigation<br/>using an existing right"]
    I --> E["Elections<br/>changing who decides"]
    A --> R["A decision changes"]
    B --> R
    C --> R
    D --> R
    E --> R
