---
title: The Civic Action Project
publish: true
created: __CREATED__
tags:
  - tasks
  - unit-3
---
**The culminating task. Ten periods across Unit 3, ending with a real
...
| --- | --- |
| 1 | Choosing the issue, and testing that it is specific enough |
| 2 | The four perspectives, written in each group's own terms |
...
It has to leave your classroom and reach someone who did not have to
listen: a letter or submission to an elected official, a deputation to a
council or board, a submission to a consultation, an organised event or
campaign with a target, a meeting you requested and obtained. What does
not count is a poster with no audience named, a post nobody was asked to
act on, or a plan you did not carry out.

## What you hand in

- **The plan** from period 4, unedited, including the success criterion
  you wrote before you knew the answer.
- **The artefact** — the letter, submission, deputation notes, campaign
  material, or event record.
- **The report**, about 1,000 words: what you did, what happened, why you
  think it happened, and what you would do differently.
...
| --- | --- |
| Analysis | Four perspectives, in their own terms, including one you disagree with |
| Choice of action | The route matches the decision-maker, the timeline, and your resources |
| Execution | It actually happened, aimed at someone real, carried out with courtesy |
| Assessment | You judge your route against the alternatives, using what doing it taught you |
| Honesty | The report says what happened, including failure, with reasons rather than excuses |
| Communication | Documents fit for their audience, sources cited, credit given to helpers |

> [!warning] The mark does not depend on whether it worked
> Read that again, because every year somebody does not believe it. You
> are marked on the quality of the action and the quality of the
> analysis. A well-targeted letter that received a form reply, a
> deputation that changed no votes, a campaign that got twelve signatures
> — all can earn full marks if the reasoning was sound and the report is
> honest.
>
...
> did not receive is the one thing here a revision cannot fix.

[[How Change Actually Happens]] is the ground, and
[[Writing to Someone in Power]] is how most of these actions are made.
