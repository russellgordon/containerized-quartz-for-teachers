...
> Groups of two or three · six bench periods across Weeks 12 to 14 ·
> demo day in Week 14 · one working gadget, one service package
...
6. Log every fault you chase, then rehearse the demo: working run,
   failure mode, diagnosis story, service package on the bench.

Powered circuits mean the [[Safety in the Lab]] absolutes apply every
period, partner within arm's reach. The bench periods are class time —
using them well is part of the task, as [[How Marks Work]] explains.
...
| Safe electrical habits | Straps on, power respected, no reminders needed |

## Reflect

Your [[Tech Journal]] entry is the fault log turned into a story:
