...
- **A build somebody else could service.** A schematic that matches the
...
- [[The Logic Machine]] — a gate circuit that remembers something,
...
> thing does for whom. Groups that write that sentence first finish
> early; groups that start by choosing components spend the last period
> discovering they built two half-projects.
