...
1. Warm-up debut: [[Binary Bites]] — decimal, binary, and hex, with the
...
- [ ] Finish the first block of [[Number Systems Practice]].
- [ ] Convert your student number to binary and to hex, showing the
      method rather than the calculator.
