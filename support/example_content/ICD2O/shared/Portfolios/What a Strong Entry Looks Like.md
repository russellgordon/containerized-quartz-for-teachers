...
strong entry could only have been written by you, about this program,
on this day. A weak one could have been written by anyone, about any
tech class, from the hallway.
...
the same day, remembered properly — a line number, an error, a cause.
And notice the strong versions are barely longer. Specific is not the
same as long; it is the difference between "it broke" and a bug you
could actually reproduce — which is exactly what [[Dev Journal]] asks
the "what broke" prompt to capture.
