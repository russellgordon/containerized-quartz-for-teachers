...
"I got better at programming" is a claim, worth what any claim is
worth: nothing yet. A good bug report never says "it's broken
somehow" — it says exactly what happened, where, and how to reproduce
...
The claim is *error messages have switched sides*. The evidence is
two moments, months apart, both on the record — and nobody can argue
with that, including the part of you that suspects you have not
changed. It is the standard [[How Marks Work]] applies everywhere:
...
- **Quote a phrase, not a page.** Your words from the time carry more
  ...
  than "I was curious about loops."
- **Then show the now.** A recent moment, just as specific, that the
  earlier self could not have managed — or would not have noticed.

> [!tip] Growth is not always writing bigger programs
> Some growth is a new noticing: reading a classmate's code in
> [[Spot the Bug]] and *seeing* the off-by-one, predicting a crash
> before the run confirms it. New noticing is growth, and your early
