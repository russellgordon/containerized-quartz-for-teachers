...
tags:
  ...
  - matter-and-bonding
---
[[Testing for Bond Type]] left you with two families of substance that
behave nothing like each other. Chemistry names them differently too,
and that is not decoration — the naming system you reach for depends on
which family you are holding, so **identifying the compound is the first
step of naming it**, not something you do afterwards.

This page is the reasoning. [[Naming Rules at a Glance]] is the same
material as a lookup sheet for when you are mid-question and just need
the rule.
...
| Melting point | high — sodium chloride melts at 801 °C | low — methane boils at −161 °C |
| What melting breaks | attractions running through the whole crystal | only the weak attractions *between* molecules |
| Conducts as a solid | no — the ions cannot move | no — there are no ions |
| Conducts molten or dissolved | yes — the ions are now free to move | no |
| Physical character | hard, brittle, cleaves along planes when struck | soft, or a liquid or gas at room temperature |
...
row, and the reason is worth saying out loud: conducting requires
charged particles that are free to move. Ionic compounds have the
charges all along and only lack the freedom; melting or dissolving
supplies it. Molecular compounds never have the charges at all.

## Ionic compounds: charges decide the formula

Write the cation first, then the anion. The metal keeps its element
name; the non-metal takes its stem and gains **-ide**. Sodium plus
chlorine gives sodium chlor**ide**; magnesium plus oxygen gives
magnesium ox**ide**.
...
Two non-metals means there are no charges to balance, so nothing tells
...
carbon mon**o**xide, not carbon oxide.

Some molecular compounds keep older names that ignore all of this —
water, ammonia, methane. Those are not exceptions to learn a rule for.
They are simply names that were in use before the system existed and
were too entrenched to change.

## Acids look like ionic compounds and are named as their own thing

A formula starting with hydrogen, in aqueous solution, is an acid, and
...
behaves as an acid at all is [[Acids and Bases]].

Naming is one of the few things in this course that is pure practice.
Understanding the system takes twenty minutes; becoming fluent takes
repetition, and that is what [[Naming Practice]] is for. Do it until you
stop needing the reference sheet, because every quantitative page after
this one assumes you can write a correct formula without thinking about
it.
