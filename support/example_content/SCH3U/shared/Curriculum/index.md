...
expectations, from **SCH3U — Chemistry, Grade 11, University
...
```mermaid
graph TD
    A["A. Investigation Skills and Careers"] --> B["B. Matter, Trends, and Bonding"]
    A --> C["C. Chemical Reactions"]
    A --> D["D. Quantities in Chemical Reactions"]
    A --> E["E. Solutions and Solubility"]
    A --> F["F. Gases and Atmospheric Chemistry"]
```
