...
A mass reported as "3.4756 g" from a balance reading to 0.01 g is not
more precise than one reported as "3.48 g" — it is less honest. See
...
municipal report, a safety data sheet, a professional body, a
peer-reviewed article. See [[What Counts as Evidence]].

**Say which way your errors push.** Naming a source of error is Grade
10. This year the sentence has to include the **direction**: *product
left on the filter paper lowers the recovered mass, so our yield is an
...
Anything you design and run is checked by me first, in writing, with the
hazards and your response to each hazard included. School reagents only,
at the concentrations supplied. Nothing from home, nothing from another
room. The full agreement is in [[Safety in the Lab]] and
[[Lab Safety and WHMIS]], and none of it is relaxed because the work is
