...
```mermaid
graph TD
    A["Casualties outrunning enlistment, 1916-17"] --> D
    B["A pledge of half a million men"] --> D
    C["Recruiting failing badly in Quebec"] --> D
    D["Military Service Act, 1917"] --> E["Intended: reinforcements"]
    D --> F["Unintended: the Union government and the 1917 election"]
    D --> G["Unintended: rioting in Quebec City, 1918"]
    D --> H["Unintended: the same argument again in 1944"]
```
