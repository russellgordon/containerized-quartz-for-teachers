...
```mermaid
flowchart TD
  A[Lesage Liberals elected, 1960] --> B[State takes over<br/>education and health]
  A --> C["Maîtres chez nous", 1962<br/>Hydro-Québec expanded]
  B --> D[A francophone middle class<br/>trained by the state]
  C --> D
  D --> E[Two answers, one question]
  E --> F[Reform Canada<br/>from within]
  E --> G[Leave]
```
