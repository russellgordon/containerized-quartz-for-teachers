...
```mermaid
graph LR
    A["Ask<br/>a question evidence<br/>could settle"] --> B
    B["Find<br/>sources that<br/>disagree"] --> C
    C["Weigh<br/>who made this,<br/>for whom, and why"] --> D
    D["Argue<br/>a claim, evidence,<br/>and the objection"] --> E
    E["Cite<br/>so someone else<br/>can check you"]
```
