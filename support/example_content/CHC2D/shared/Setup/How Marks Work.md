...
| --- | --- | --- |
| Term work | 70% | Written arguments, source analysis, seminars, and the portfolio |
| Final evaluation | 30% | [[The Commemoration Inquiry]] and [[The Document Examination]] |

## Inside the term work

| Kind of work | Roughly | What it is |
| --- | --- | --- |
| Written argument | 30% | The essays and position papers — a claim, evidence, and the strongest objection to it |
| Source analysis | 20% | What you can establish from a document you have not seen before |
| Seminars | 10% | Prepared participation, judged on evidence used and positions represented fairly |
| Portfolio | 10% | [[Your Inquiry Notebook]] and the two reflections, marked as a set |
...
Some tasks can be revised after feedback. The task page says so when it
applies, because on those the revision is the skill being assessed —
[[Building an Argument]] is written on the assumption that no first
draft survives contact with a good objection.
