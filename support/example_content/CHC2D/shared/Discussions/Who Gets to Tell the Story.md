...
```mermaid
graph TD
    A["What happened"] --> B["Who was present<br/>and able to record it"]
    B --> C["What was written<br/>down, filmed, filed"]
    C --> D["What an archive<br/>chose to keep"]
    D --> E["What a historian<br/>found and used"]
    E --> F["The account<br/>you are reading"]
```
