...
```mermaid
flowchart TD
  A[Cabinet removes land] --> C[Farm groups and residents object]
  A --> D[Auditor General audits the process]
  C --> E[Sustained public pressure]
  D --> E
  E --> F[Decision reversed, September 2023]
```
