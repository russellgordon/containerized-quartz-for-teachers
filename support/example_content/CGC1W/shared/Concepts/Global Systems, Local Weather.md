---
title: Global Systems, Local Weather
publish: true
created: __CREATED__
tags:
  - concepts
...
```mermaid
graph LR
    P["Unusually warm water<br/>in the tropical Pacific"] --> J["The jet stream<br/>shifts its usual path"]
    J --> W["Milder, drier winter<br/>across western Canada"]
    W --> S["Thinner snowpack<br/>by spring"]
    S --> F["Drier forest fuels<br/>by midsummer"]
```
