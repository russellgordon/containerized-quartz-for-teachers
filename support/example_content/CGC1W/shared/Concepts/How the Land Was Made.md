...
```mermaid
graph TD
    A["Mountains build, then erode to a plain"] --> B["Shallow seas lay down sediment"]
    B --> C["Ice sheets scrape, gouge, and dump"]
    C --> D["Meltwater and waves rework the debris"]
    D --> E["The shoreline you walked on"]
```
