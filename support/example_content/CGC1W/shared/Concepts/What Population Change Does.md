---
title: What Population Change Does
publish: true
created: __CREATED__
tags:
  - concepts
...
```mermaid
flowchart LR
  A[More people over 65] --> B[More home and long-term care]
  A --> C[Fewer workers per retiree]
  B --> D[Municipal and provincial budgets]
  C --> D
  D --> E[Wait times, taxes, new services]
```
