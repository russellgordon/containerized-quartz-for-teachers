...
```mermaid
graph TD
    P["Rain and snowmelt"] --> L["Fields, roads, roofs, lawns"]
    L --> T["Tributary streams"]
    T --> R["River"]
    R --> K["Lake"]
    K --> I["Drinking water intake"]
    L -.->|road salt, nutrients, sediment| T
    W["Sewage treatment outfall"] --> R
    R -.->|withdrawals| F["Farms and industry"]
```
