...
```mermaid
graph LR
    A["Gather<br/>field data,<br/>census, interviews"] --> B["Handle<br/>clean, classify,<br/>map, graph"]
    B --> C["Reason<br/>pattern, cause,<br/>scale, perspective"]
    C --> D["Communicate<br/>to someone<br/>who must decide"]
```
