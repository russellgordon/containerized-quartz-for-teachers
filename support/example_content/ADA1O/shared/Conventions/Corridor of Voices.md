...
```mermaid
graph LR
    A["Name the decision<br/>in one sentence"] --> B["Form two lines,<br/>assign each side a pull"]
    B --> C["Character walks<br/>slowly through"]
    C --> D["One voice at a time<br/>as they pass"]
    D --> E{"At the end:<br/>the character decides"}
```
