...
```mermaid
graph LR
    U["Upstream use<br/>withdrawal, discharge,<br/>land clearing"] --> C["Shared channel"]
    C --> D["Downstream effect<br/>less water, worse water,<br/>different timing"]
    D --> N["Negotiation<br/>agreement, allocation,<br/>or conflict"]
    N -.->|rules bind| U
```
