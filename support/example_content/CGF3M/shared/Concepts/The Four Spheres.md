...
```mermaid
graph TD
    A["Atmosphere<br/>gases, energy, moisture"] --- H["Hydrosphere<br/>oceans, ice, ground water"]
    H --- L["Lithosphere<br/>crust and upper mantle"]
    L --- B["Biosphere<br/>everything alive"]
    B --- A
    A --- L
    H --- B
```
