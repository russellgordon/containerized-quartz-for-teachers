...
```mermaid
graph LR
    F["Fuel<br/>how much, how dry,<br/>how continuous"] --> B["Fire behaviour"]
    W["Weather<br/>temperature, humidity,<br/>wind, drought"] --> B
    T["Topography<br/>slope, aspect,<br/>valley shape"] --> B
    B --> S["Rate of spread<br/>and intensity"]
```
