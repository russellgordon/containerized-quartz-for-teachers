---
title: The Geographic Inquiry Process
draft: false
created: __CREATED__
tags:
  - tutorials
...
```mermaid
graph LR
    F["Formulate<br/>Questions"] --> G["Gather and<br/>Organize"]
    G --> I["Interpret and<br/>Analyse"]
    I --> E["Evaluate and Draw<br/>Conclusions"]
    E --> C["Communicate"]
    I -.->|new question| F
    E -.->|not enough evidence| G
```
