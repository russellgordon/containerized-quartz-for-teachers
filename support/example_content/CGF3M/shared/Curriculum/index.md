...
```mermaid
graph TD
    A["A. Geographic Inquiry and Skill Development"]
    B["B. Spatial Organization: Spheres of the Earth"]
    C["C. The Physical Environment: Sustainability and Stewardship"]
    D["D. Systems: Interaction and Interdependence"]
    E["E. Impacts of Change"]
    A --> B
    A --> C
    A --> D
    A --> E
