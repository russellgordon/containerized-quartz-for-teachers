...
- [ ] Foggy things are located, not just felt — "I forget to ask
      whether the second draw came from a changed bag", not
...
- [ ] Every entry since the launch carries its one-line update
- [ ] Every decision about data is dated and *justified* — why this
      source, why these variables, why I abandoned the other one
- [ ] Anything I would need in order to write the limitations section
      is written down somewhere, not being held in my head

> [!tip] The last three boxes are the whole game
> Anyone can write "I will check my work more." The journal becomes
> evidence the day a later entry says "I tried drawing the tree
> before reaching for a formula, and the dependent branch showed up
> on its own" — a loop from intention to attempt to result. The
> investigation boxes do the same job across months: in the final
> week you will need to explain a choice you made in the second unit,
> and only the journal remembers it. [[Showing Growth]] will ask you
> to point at both kinds, so leave yourself things to point at.
