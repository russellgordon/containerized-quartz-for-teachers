...
```mermaid
graph TD
    P["Mathematical Processes"] --> A["A. Counting and Probability"]
    P["Mathematical Processes"] --> B["B. Probability Distributions"]
    P["Mathematical Processes"] --> C["C. Organization of Data for Analysis"]
    P["Mathematical Processes"] --> D["D. Statistical Analysis"]
    P["Mathematical Processes"] --> E["E. Culminating Data Management Investigation"]
```
