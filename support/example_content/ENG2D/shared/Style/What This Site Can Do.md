...
> The Prologue tells you the ending in fourteen lines, which means the
> play is not built on suspense. It is built on watching people walk
> toward something the audience can already see.
...
| --- | --- | --- |
| Simile | Compares using *like* or *as* | "A Secret Lost in the Water" |
| Allusion | Points at another text or event | *Romeo and Juliet* |
| Juxtaposition | Sets two things side by side to make a point | *Moon of the Crusted Snow* |
...
Two lines of *Romeo and Juliet*, set as a block quotation because verse
...
links here, gathered automatically. Open [[Narrative Perspective]] and you can
