...
**70%** across the course; **30%** for the final evaluation —
[[Final Examination]] and the last stage of [[The Independent Study]].

Later work counts for more. That is not leniency; it is what a mark is
supposed to describe.

## The independent study, and why it is weighted where it is

It runs across six months with four checkpoints, each assessed, and ends
in an oral defence. That is not decoration: being asked "why that
passage and not the one before it?" in front of somebody is the fastest
way to find out whether an argument is yours.
