...
[[Investigation Write-Ups]] that run from Unit 1 to Unit 4,
[[The Roller Coaster Loop, Properly]], the [[Fields Technology Report]],
and the [[Optics Investigation Report]]. They are not equally weighted.
...
in the last week, and the [[Final Examination]], written on paper in the
examination period. Between them they reach across the whole course — the
examination over all five units, the seminar into the one place where the
physics is still being argued about. That is what a final evaluation is
for: not a fifth unit test, but one last look at whether the whole course
is in there. The examination is the larger of the two.

Everything I mark has its own page in [[Tasks/index|Tasks]], and every one
of those pages says how it will be judged before you start it. If a task
page does not say, that is a bug — tell me and I will fix the page.

## What is not assessed

Practice sets. Warm-ups. Rough work and first drafts. The
[[Physics Journal]] — it is yours, I read it, and it is not marked. Being
wrong at the board. The end-of-unit checkpoints, which you mark yourself.

That is deliberate rather than generous. Practice you do between classes
is practice, and a course that marks it is partly marking how much help
you have at home. So the work that carries your mark is done **here**, in
periods set aside for it, with me in the room — which is also the only
arrangement under which asking for help is not cheating.
...
The four are not weighted equally either, and they shift from task to
task: the [[Optics Investigation Report]] is almost entirely Thinking and
...
mathematics, the living skills in health and physical education.
**Physics does not have one.** Every expectation in this course is about
...
Talk to me before the due date and it is a conversation — a new date, a
smaller piece, whatever gets the work done. Talk to me after it and I
mark what I have.

Handing work in on time is a work habit, so it is reported as one, under
responsibility. It is not a deduction from your percentage: a mark that
