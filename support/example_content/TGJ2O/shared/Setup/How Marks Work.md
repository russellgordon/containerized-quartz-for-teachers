...
because it is the rehearsal that makes the other three possible. The
...
[[A3.3|The teamwork expectation]] asks you to describe *and use* the
techniques that make a team work — so on [[The Athletics Package]] you
name the technique that settled your crew's biggest disagreement, and
that naming is marked like anything else in the curriculum. What is
...
of its own — [[B1.2|time-management tools, used so deadlines are met]]
