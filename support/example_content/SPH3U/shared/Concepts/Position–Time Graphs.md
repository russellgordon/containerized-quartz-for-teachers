...
```mermaid
graph LR
    A["Flat line"] --> B["Not moving"]
    C["Straight, sloping up"] --> D["Constant velocity, positive"]
    E["Straight, sloping down"] --> F["Constant velocity, negative"]
    G["Curving upward"] --> H["Speeding up"]
```
