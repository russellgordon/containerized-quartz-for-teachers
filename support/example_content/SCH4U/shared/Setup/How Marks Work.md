...
| --- | --- | --- |
| Knowledge and understanding | 25% | Tests, quizzes, concept checks, naming and structure work |
| Thinking and investigation | 30% | Investigation design, analysis, uncertainty, limitations, model boundaries |
| Communication | 20% | Reports, equations written properly, presentations, discussions |
| Application | 25% | Tasks connecting chemistry to real situations |

The final mark is **70% term work and 30% final assessment**. The final
assessment is [[The Chemistry Showcase]] together with a final
examination — the showcase asks whether you can put the whole course
together on something you chose, and the examination asks whether the
core of it is yours without notes.
...
The eight investigations and the five tasks carry real weight between
them. They are not decoration on top of the tests; they are the part of
the course where you have to put everything together at once, which is
the only place I can see whether you can.

## A defensible wrong prediction beats a lucky right one

This is the sentence people find hardest to believe, so it is going
early and in plain words. **A prediction that turns out wrong, made from
a stated model, for a stated reason, is worth more here than a
prediction that turned out right and cannot be accounted for.**
...
>
> This applies on tests as well as in reports. If a question asks you to
> predict from a model and you add a sentence about the model's
> boundary, that sentence is marked. If the boundary is the actual point
