...
```mermaid
graph LR
    A["Investigate"] --> B["Compare what groups measured"]
    B --> C["Name the idea, and the model it comes from"]
    C --> D["Find where the model stops being true"]
    D --> E["Use it, knowing its limits"]
```
