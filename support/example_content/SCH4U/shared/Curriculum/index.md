...
expectations, from **SCH4U — Chemistry, Grade 12, University
...
```mermaid
graph TD
    A["A. Investigation Skills and Careers"] --> B["B. Organic Chemistry"]
    A --> C["C. Structure and Properties of Matter"]
    A --> D["D. Energy Changes and Rates of Reaction"]
    A --> E["E. Chemical Systems and Equilibrium"]
    A --> F["F. Electrochemistry"]
```
