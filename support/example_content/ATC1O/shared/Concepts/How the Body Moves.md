...
```mermaid
graph TD
  S[Skeleton] --> A["Axial<br/>skull, spine, ribs"]
  S --> P["Appendicular<br/>shoulder girdle, arms, pelvis, legs"]
  A --> AJ["Supports and stabilises"]
  P --> PJ["Reaches, travels, bears weight"]
```
