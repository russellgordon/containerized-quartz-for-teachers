...
is about the footage afterwards.

## Watching yourself without flinching

Everybody's first reaction is to watch their own face and body rather than
their own dancing. It passes, but only if you give it a job. Watch each clip
three times, with a different job each time.

1. **Once through, no notes.** Let the flinch happen and finish.
2. **Once with the sound off**, watching one thing only — the feet, or the
   spine, or where your eyes go. One element per pass, from
   [[The Elements of Dance]].
3. **Once at half speed**, to find the exact frame where something changes —
   the moment the weight arrives late, or the transition that eats the shape.

Then write four lines in [[Your Movement Journal]]: two things the body does
well and two you did not know about. Notice the wording — *the body*, not *I
am bad at*. The camera is not an opinion about you; it is the only outside
view of your own work you will get, and [[Content and Interpretation]] is what
to do with it.

> [!tip] Keep every version
