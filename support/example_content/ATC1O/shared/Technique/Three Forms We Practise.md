...
```mermaid
graph LR
    A["Learn the<br/>vocabulary"] --> B["Learn a taught<br/>combination"]
    B --> C["Break it into<br/>chunks"]
    C --> D["Re-order and<br/>re-sequence"]
    D --> E{"Does it still<br/>sound like the form?"}
```
