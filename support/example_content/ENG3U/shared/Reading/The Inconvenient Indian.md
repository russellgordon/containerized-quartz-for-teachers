...
> People in North America* (Doubleday Canada, 2012) · read in extracts ·
...
Not a history, as King says himself, and not a memoir — an argument,
built out of history, anecdote, and film criticism, about how North
America has told stories about Indigenous people and what those stories
were for.

That makes it the right text for learning to read non-fiction: you can
watch an argument being constructed in front of you, complete with the
jokes doing structural work.

## What to notice

- **The voice.** Direct address, asides, and self-interruption. Ask what
  the informality achieves that a formal history could not — and what it
  gives up.
- **The categories.** Dead Indians, Live Indians, Legal Indians. Track
  how the argument uses them, and test them against
  [[Monkey Beach]].
- **The evidence.** Where he uses a document, where an anecdote, where a
  film. Which is doing the persuading, per [[Reading Non-Fiction]]?
...
1. What is King's central claim? State it in one sentence he would
   accept.
2. Is the humour a rhetorical strategy, a survival strategy, or both?
3. Where is the strongest objection to his argument, and does he meet it?
4. Reading this next to *Monkey Beach*: what can a novel do that an
   argument cannot, and the reverse?
