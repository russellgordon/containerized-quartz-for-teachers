...
1. Random groups: run the definition on $f(x) = x^2$ at $x = 3$, then
...
- [ ] Journal (new volume): conjecture the derivative of $x^{17}$
      without computing a single limit — and bring the conjecture.
