...
1. Number talk: [[Which One Doesn't Belong]] — $x + y = 1$, $z = 5$,
   $y = x$, $x + y + z = 1$: in three-space, which is the odd one out?
2. Random groups — [[Where Planes Meet]]: three sheets of cardboard,
   and every configuration you can force them into
3. Consolidate: [[Equations of Planes]], then
