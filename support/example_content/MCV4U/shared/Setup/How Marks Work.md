...
pie title Where evidence comes from
    ...
    "Number talks and class thinking" : 15
```
...
[[Showing Your Thinking]] is most of the discipline. An optimization
whose candidate you tested against the endpoints outranks a memorised
answer — and a model whose every parameter you can defend outranks a
perfect fit you cannot explain, the standard [[What Makes a Model Good]]
argues for and the tasks apply.
