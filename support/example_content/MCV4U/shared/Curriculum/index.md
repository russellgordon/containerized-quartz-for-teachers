...
```mermaid
graph TD
    P["Mathematical Processes"] --> A["A. Rate of Change"]
    P["Mathematical Processes"] --> B["B. Derivatives and Their Applications"]
    P["Mathematical Processes"] --> C["C. Geometry and Algebra of Vectors"]
```
