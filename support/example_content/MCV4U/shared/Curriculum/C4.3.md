...
*Sample problem:* How does the relationship $\vec{a} \cdot (\vec{b} \times \vec{c}) = 0$ help you determine whether three non-parallel planes intersect in a point, if $\vec{a}$, $\vec{b}$, and $\vec{c}$ represent normals to the three planes? ^text
