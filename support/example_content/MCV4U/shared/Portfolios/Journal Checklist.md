...
- [ ] Foggy things are located, not just felt — "I forget to test
      whether my critical point is a maximum or a minimum", not
      "optimization is confusing"
...
> evidence of growth the day a later entry says "I nudged our
> optimal width a millimetre each way, and the volume dropped on
> both sides — the critical point held" — a loop from intention to
> attempt to result. That loop is exactly what [[Showing Growth]]
> will ask you to point at, so leave yourself things to point at.
