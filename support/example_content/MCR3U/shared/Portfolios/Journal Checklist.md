...
- [ ] Foggy things are located, not just felt — "I lose the sign on
      $d$ in $f(x - d)$", not "transformations are confusing"
...
> evidence of growth the day a later entry says "I tested my
> sinusoidal model against an hour of data we had not used, and it
> caught the shift I had guessed wrong" — a loop from intention to
