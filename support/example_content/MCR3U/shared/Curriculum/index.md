...
```mermaid
graph TD
    P["Mathematical Processes"] --> A["A. Characteristics of Functions"]
    P["Mathematical Processes"] --> B["B. Exponential Functions"]
    P["Mathematical Processes"] --> C["C. Discrete Functions"]
    P["Mathematical Processes"] --> D["D. Trigonometric Functions"]
```
