...
*Sample problem:* Explain in a variety of ways how you can distinguish the exponential function $f(x) = 2^x$ from the quadratic function $f(x) = x^2$ and the linear function $f(x) = 2x$. ^text
