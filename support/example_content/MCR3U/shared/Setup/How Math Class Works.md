...
with it, not before — the function machine before the word "function",
the Ferris wheel before the word "sinusoidal". Marker in hand, one
rule: the person holding the marker writes only other people's ideas.
