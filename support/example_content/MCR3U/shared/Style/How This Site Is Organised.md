...
a concept links to the explorations that build it and the practice that
tests it — [[Sinusoidal Functions]] points back to the Ferris wheel
that made it necessary — and the **Backlinks** panel at the bottom of
any page shows every page pointing the other way. Start anywhere and
follow the thread.
