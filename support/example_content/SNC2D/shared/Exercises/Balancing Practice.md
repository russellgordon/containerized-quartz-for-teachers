...
tags:
  ...
  - exercises
---
Count in a table. Balance the element that appears in the fewest
...
**5.** Write a balanced chemical equation, with state symbols, for:
*solid calcium carbonate is heated and decomposes into solid calcium
...
> checked.
>
> The state symbols carry the interesting part of this reaction. A
> solid becomes a solid **and a gas**, so an open container loses mass
> while a sealed one does not — which is exactly what your group saw in
...
> different one and then balances a reaction nobody performed. Only
> **coefficients** may be changed.
>
> **The second student wrote a balanced equation that is not in lowest
> terms.** Count it: 8 H and 4 O on each side. It is true, and it says
...
> untidy form. The first has written something false: an equation
> claiming that burning hydrogen produces hydrogen peroxide. Tidiness
> is a convention; identity is a fact about the world.

**8.** (a) A sealed vessel contains 12.0 g of magnesium and 8.0 g of
oxygen. The reaction runs until both are completely used up. What is
the mass of magnesium oxide produced, and how do you know? (b) The same
12.0 g of magnesium is burned in an **open** crucible, and the white
powder left behind masses 19.8 g. A student says mass was created.
Respond.

> [!success]- Answer 8
> **(a) 20.0 g.** Nothing entered the sealed vessel and nothing left
> it, so the total mass inside cannot change:
> $12.0\ \text{g} + 8.0\ \text{g} = 20.0\ \text{g}$. Every atom that
> was in there is still in there, rearranged. That is the law of
> conservation of mass, and it is the reason an equation has to balance
> at all.
>
> **(b)** Mass was not created — mass was **added**, from outside the
> crucible. The magnesium combined with oxygen from the air, and the
> oxygen's mass is now part of the powder. An open container is not a
> closed system, so nothing about conservation is threatened by the
> reading going up.
>
> There is a second thing worth noticing in that number. If all the
> oxygen that combined stayed in the crucible, the powder should mass
> slightly more than 19.8 g — in practice some of the product escapes
> as fine white smoke while it burns, so an open-crucible result tends
> to come out **low**. Saying which way an error pushes is what
> separates a limitation from a shrug.

Reference: [[Balancing Equations]] and [[Chemical Equations]]. Sorting
these reactions into families is [[Reaction Types Practice]].
