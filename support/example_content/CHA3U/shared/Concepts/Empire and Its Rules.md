...
```mermaid
flowchart TD
  A[War debt after the Seven Years' War] --> B[Revenue Act 1764]
  A --> C[Stamp Act 1765]
  A --> D[Royal Proclamation 1763<br/>limits settlement west]
  C --> E[Colonial protest and boycott]
  E --> F[Stamp Act repealed<br/>Declaratory Act 1766]
  F --> G["Parliament claims authority<br/>'in all cases whatsoever'"]
  G --> H[Townshend Duties 1767]
  D --> I[Settler anger at the frontier line]
```
