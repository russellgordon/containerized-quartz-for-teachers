...
```mermaid
flowchart TD
  A[Cotton gin<br/>1790s] --> B[Inland short-staple cotton<br/>becomes profitable]
  B --> C[Planters push west into<br/>Alabama, Mississippi, Louisiana]
  C --> D[Native nations pressured<br/>and removed from that land]
  C --> E[Domestic slave trade moves<br/>people from the Upper South]
  E --> F[Families separated by sale]
  B --> G[Raw cotton feeds mills in<br/>Britain and New England]
  G --> H[Northern capital invested<br/>in a Southern system]
```
