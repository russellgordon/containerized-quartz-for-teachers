...
```mermaid
graph TD
    A["Decades of anti-Asian law and agitation"] --> D
    B["Pearl Harbor, December 1941"] --> D
    C["Military and political pressure from the West Coast"] --> D
    D["Executive Order 9066, February 1942"] --> E["Stated: military areas and exclusion authority"]
    D --> F["Actual: about 122,000 people removed"]
    D --> G["Property and businesses lost, largely unrecovered"]
    D --> H["Redress legislation four decades later"]
```
