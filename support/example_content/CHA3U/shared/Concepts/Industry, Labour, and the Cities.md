---
title: Industry, Labour, and the Cities
publish: true
created: __CREATED__
tags:
  - concepts
...
```mermaid
flowchart TD
  A[Railways, steel, oil<br/>at continental scale] --> B[Corporations and trusts]
  B --> C[Enormous concentrated fortunes]
  B --> D[Wage work replaces<br/>the independent trade]
  D --> E[Long hours, injury,<br/>child labour, no security]
  E --> F[Unions organize]
  F --> G[Strikes met by injunctions,<br/>private guards, and troops]
  C --> H[Political influence]
  H --> I[Antitrust and regulation<br/>demanded in response]
  G --> I
```
