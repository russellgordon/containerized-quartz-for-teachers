---
title: Interpretation and Historiography
draft: false
created: __CREATED__
tags:
  - concepts
...
```mermaid
graph LR
    A["The event"] --> B["First accounts<br/>by participants,<br/>defending themselves"]
    B --> C["A generation later<br/>national story,<br/>written for schools"]
    C --> D["New sources open<br/>records released,<br/>testimony collected"]
    D --> E["New questions asked<br/>by people previously<br/>left out of the telling"]
    E --> F["Today's account<br/>arguing with all<br/>four of the above"]
```
