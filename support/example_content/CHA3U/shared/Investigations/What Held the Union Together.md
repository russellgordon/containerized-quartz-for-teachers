...
```mermaid
graph TD
    A["What held it together?"] --> B["Compromises over slavery<br/>in new territory"]
    A --> C["Shared institutions<br/>parties, courts, the army"]
    A --> D["Economic interdependence<br/>cotton, credit, shipping"]
    A --> E["A common story<br/>the Revolution, remembered"]
    B --> F["Each one bought time<br/>and raised the stakes"]
    C --> G["Parties themselves split<br/>along the same line"]
    D --> H["Interdependence cut<br/>both ways"]
    E --> I["Both sides claimed<br/>the same founders"]
```
