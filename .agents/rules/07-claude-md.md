...
trigger: always_on
glob:
description: "Plantoir project rules, part 7 of 7 - The two handoff documents, and where a Windows session begins"
---

<!-- Part 7 of 7 of a COPY of CLAUDE.md. Do not edit this file:
